...
namespace Abp.Authorization.Users
{
        ...
        where TUser : AbpUser<TUser>
    {
        ...
        public override async Task<IdentityResult> ResetPasswordAsync(TUser user, string code, string password)
        {
            (await base.ResetPasswordAsync(user, code, password)).CheckErrors();
            return IdentityResult.Success;
        }
