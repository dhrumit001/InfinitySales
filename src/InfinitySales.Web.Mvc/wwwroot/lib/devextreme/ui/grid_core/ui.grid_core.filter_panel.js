...
var FilterPanelView = _uiGrid_core2.default.View.inherit({
    ...
    _getFilterElement: function() {
        ...
        (0, _accessibility.registerKeyboardAction)("filterPanel", that, $element, void 0, function() {
            return that._showFilterBuilder()
        });
    ...
    _getTextElement: function() {
        ...
        (0, _accessibility.registerKeyboardAction)("filterPanel", that, $textElement, void 0, function() {
            return that._showFilterBuilder()
        });
    ...
    _getRemoveButtonElement: function() {
        ...
        (0, _accessibility.registerKeyboardAction)("filterPanel", this, $element, void 0, clearFilterValue);
        that._addTabIndexToElement($element);
        return $element
    },
