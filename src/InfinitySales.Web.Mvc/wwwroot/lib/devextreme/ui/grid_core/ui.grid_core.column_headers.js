            ...
            return {
                ...
                _getDefaultTemplate: function(column) {
                    ...
                    return function($container, options) {
                        var $content = column.command ? $container : createCellContent(that, $container, options),
                            caption = !(0, _type.isDefined)(column.groupIndex) && column.caption;
                        if (caption) {
                ...
                _createRow: function(row) {
                    ...
                    if ("header" === row.rowType) {
                        ...
                        if (!this._isLegacyKeyboardNavigation()) {
                            (0, _accessibility.registerKeyboardAction)("columnHeaders", this, $row, "td", this._handleActionKeyDown.bind(this))
                        }
                    }
                    return $row
                },
