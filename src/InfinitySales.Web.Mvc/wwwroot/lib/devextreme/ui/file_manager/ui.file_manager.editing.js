    ...
    _createClass(FileManagerEditingControl, [{
        ...
        value: function() {
            ...
            this._editActions = {
                create: {
                    ...
                    getErrorMessage: function(_ref5, info) {
                        var _ref6 = _slicedToArray(_ref5, 1),
                            name = _ref6[0].name;
                        return "Create folder operation failed for the " + name + " parent folder"
                    }
                },
                rename: {
                    dialog: this._renameItemDialog,
                    getDialogArgument: function(_ref7) {
                        var _ref8 = _slicedToArray(_ref7, 1),
                            name = _ref8[0].name;
                        return name
                    },
                    action: function(_ref9, _ref10) {
                    ...
                    getErrorMessage: function(_ref12, info) {
                        var _ref13 = _slicedToArray(_ref12, 1),
                            name = _ref13[0].name;
                        return "Rename operation failed for the " + name + " item"
                    }
                },
                "delete": {
                    dialog: this._confirmationDialog,
                    getDialogArgument: function(_ref14) {
                    ...
                    getErrorMessage: function(items, _ref16) {
                        var index = _ref16.index;
                        return "Delete operation failed for the " + items[index].name + " item"
                    }
                },
                move: {
                    ...
                    getErrorMessage: function(items, info) {
                        return "Move operation failed for the " + items[info.index].name + " item"
                    }
                },
                copy: {
                    dialog: this._chooseFolderDialog,
                    ...
                    getErrorMessage: function(items, info) {
                        return "Copy operation failed for the " + items[info.index].name + " item"
                    }
                },
        ...
        value: function() {
            ...
            (0, _iterator.each)(this._editActions, function(name, action) {
                if (_this5._editActions.hasOwnProperty(name)) {
        ...
        value: function(action, arg) {
            ...
            this._showDialog(action.dialog, dialogArgumentGetter(items)).then(function(dialogResult) {
                ...
                (0, _uiFile_manager2.default)(result, function() {
                    ...
                    var fileItem = items[info.index];
                    _this6._raiseOnError(info.errorId, fileItem)
                })
            })
        }
    }, {
