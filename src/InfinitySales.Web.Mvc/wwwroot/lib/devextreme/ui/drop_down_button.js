    ...
    _popupOptions: function() {
        ...
        return (0, _extend.extend)({
            ...
            closeOnOutsideClick: function(e) {
                var $toggleButton = (0, _renderer2.default)(e.target).closest("." + DROP_DOWN_BUTTON_TOGGLE_CLASS);
                if (!$toggleButton.length) {
                    return true
                }
                var $element = $toggleButton.closest("." + DROP_DOWN_BUTTON_CLASS);
                return $element.get(0) !== _this3.$element().get(0)
            },
            showTitle: false,
            animation: {
                show: {
