...
var TooltipStrategyBase = exports.TooltipStrategyBase = function() {
    ...
    _createClass(TooltipStrategyBase, [{
        ...
        value: function(target, dataList) {
            var _this = this;
            var $list = (0, _renderer2.default)("<div>");
            return this.scheduler._createComponent($list, _uiList2.default, {
                dataSource: dataList,
        ...
        value: function(data, currentData) {
            ...
            this.scheduler._createComponent($deleteButton, _button2.default, {
                ...
                onClick: function(e) {
                    ...
                    _this4.scheduler._checkRecurringAppointment(data, currentData, _this4.scheduler._getStartDate(currentData, true), function() {
