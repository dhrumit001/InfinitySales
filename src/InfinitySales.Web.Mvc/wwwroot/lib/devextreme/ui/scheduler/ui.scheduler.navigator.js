...
var formatCaptionByMonths = function(lastDate, firstDate) {
    var lastDateText, firstDateText, isDifferentMonthDates = firstDate.getMonth() !== lastDate.getMonth(),
...
var getMonthCaption = function(date) {
    var text, firstDate = new Date(date),
        ...
        case "agenda":
            ...
            return {
                duration: agendaDuration, setter: "setDate", getter: "getDate", getDate: dateGetter, getCaption: function(date) {
                    var text, format = getCaptionFormat(this.option("_useShortDateFormat")),
