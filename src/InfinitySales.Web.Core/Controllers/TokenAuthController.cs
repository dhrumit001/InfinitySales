...
using Abp.UI;
using InfinitySales.Authentication.External;
using InfinitySales.Authentication.JwtBearer;
using InfinitySales.Authorization;
using InfinitySales.Authorization.Users;
using InfinitySales.Models.TokenAuth;
using InfinitySales.MultiTenancy;

namespace InfinitySales.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : InfinitySalesControllerBase
    {
                ...
                case AbpLoginResultType.UnknownExternalLogin:
                    {
                        ...
                        loginResult = await _logInManager.LoginAsync(new UserLoginInfo(model.AuthProvider, model.ProviderKey, model.AuthProvider));
